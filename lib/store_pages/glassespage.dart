...
class _GlassesPageState extends State<GlassesPage> {
  final List<ClothingItem> glassesItems = [
    ClothingItem(category: 'Glasses', name: 'Glasses 1', imagePath: 'assets/glasses/1.png', cost: 25.0, top: 50, left: 75, size: 100, top_ingame: 50, left_ingame: 98),
    ClothingItem(category: 'Glasses', name: 'Glasses 2', imagePath: 'assets/glasses/2.png', cost: 30.0, top: 50, left: 75, size: 100, top_ingame: 50, left_ingame: 98),
  ];
        ...
        children: [
                    ...
                    return Padding(
                      ...
                      child: Card(
                        ...
                        child: Column(
                          ...
                          children: [
                            Image.asset(
                              glassesItems[index].imagePath,
                              width: 100,
                              height: 100,
                            ),
                            SizedBox(height: 8),
                            Text(glassesItems[index].name),
                            SizedBox(height: 8),
                            Text('Cost: \$${glassesItems[index].cost.toStringAsFixed(2)}'),
                          ],
                        ),
                      ),
                    );
          ...
          child: Align(
            ...
            child: ElevatedButton(
              onPressed: () {
                ClothingItem selectedItem = glassesItems[_currentPage];
