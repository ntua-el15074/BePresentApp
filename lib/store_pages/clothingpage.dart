...
class _ClothingPageState extends State<ClothingPage> {
  ...
  final List<ClothingItem> clothingItems = [
    ClothingItem(category: 'Clothing', name: 'Clothing 1', imagePath: 'assets/clothing/1.png', cost: 20.0, top: 15, left: 0, size: 255, top_ingame: 15, left_ingame: 25),
    ClothingItem(category: 'Clothing', name: 'Clothing 2', imagePath: 'assets/clothing/2.png', cost: 30.0, top: 15, left: 0, size: 255, top_ingame: 15, left_ingame: 25),
  ];
        ...
        children: [
                      ...
                      child: Card(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 8),
                            Text(clothingItems[index].name),
                            SizedBox(height: 8),
                            Text('Cost: \$${clothingItems[index].cost.toStringAsFixed(2)}'),
                          ],
                        ),
                      ),
                    );
          ...
          Padding(
            ...
            child: ElevatedButton(
              onPressed: () {
                ClothingItem selectedItem = clothingItems[_currentPage];
